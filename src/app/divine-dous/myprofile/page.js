                        ...
                        <div className="flex flex-col md:grid grid-cols-2 w-full text-sm md:text-sm py-2 gap-3  gap-y-2 px-2">
                            <div className="flex flex-col gap-y-2 border-r-0 md:border-r-2 border-gray-300">
                                ...
                                <MyProfileData
                                    title="Denomination"
                                    data={
                                        user.profileData?.lookingforDenomination
                                    }
                                />
                                <MyProfileData
                                    title="Ethnic Origin"
                                    data={
                                        user.profileData?.lookingforEthnicOrigin
                                    }
                                />
                                <MyProfileData
                            ...
                            <div className="flex flex-col gap-y-2">
                                ...
                                <MyProfileData
                                    title="Living State"
                                    data={
                                        user.profileData?.lookingforStateLiving
                                    }
                                />
                                <MyProfileData
                                    title="Living City"
                                ...
                                <MyProfileData
                                    title="Annual Income"
                                    data={
                                        user.profileData?.lookingforAnnualIncome
                                    }
                                />
                            </div>
                        </div>
