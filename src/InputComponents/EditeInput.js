...
export function EditOptionsInput({ name, options, inputHandler, label }) {
    return (
        <>
            <div className={`grid  items-center ${label ?  'grid-cols-2': 'grid-cols-1'}`}>
                <label className='text-sm md:text-base peer-focus:text-black '>{label}</label>
...
export  function EditTextinput({ id, name, value, onChange, placeholder, label }) {
    return (
        <>
