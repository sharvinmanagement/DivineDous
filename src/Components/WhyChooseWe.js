...
export default function WhyChooseWe() {
  return (
    <>
      ...
      <h1 className="text-darken mb-3 text-xl font-medium lg:px-14 ">Embrace Unity in Diversity: </h1>
      <p className="px-4 text-gray-500"> Explore Matches from Diverse Communities on DivineDous. Simplifying Your Search for Love Beyond Boundaries.!</p>
    </div>
    ...
    <div  className="rounded-xl bg-white p-6 text-center shadow-lg">
      ...
      <h1 className="text-darken mb-3  text-xl font-medium  lg:px-14">Break Language Barriers, Embrace Love Unrestricted:</h1>
      <p className="px-4 text-gray-500">Begin Your Quest for the Ideal Match, Now Accessible in a Multilingual Haven on DivineDous.</p>
    </div>
        </div>
      </div>
