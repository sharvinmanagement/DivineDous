...
export default function NavBar() {
  ...
  return (
    <>
      <nav className={`fixed  top-0 px-3 lg:px-11 lg:px-20 py-1 w-full text-${scrollY > 10 ? 'black' : 'white'}   flex justify-between items-center bg-${scrollY > 10 ? 'white' : 'transparent'}  transition duration-300 ease-in-out z-30 drop-shadow-lg`} >
